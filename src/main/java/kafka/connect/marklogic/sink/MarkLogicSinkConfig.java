...
import kafka.connect.marklogic.MarkLogicJsonBufferedWriter;
...
public class MarkLogicSinkConfig extends AbstractConfig {    
	...
	private static final String WRITER_IMPL_DEFAULT = MarkLogicJsonBufferedWriter.class.getCanonicalName();
